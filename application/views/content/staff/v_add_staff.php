        ...
        <div class="card-body">
            <form id="form-tambah-staff" method="post" action="<?= site_url('staff/insert') ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input require type="text" class="form-control" name="jabatan_staff">
                </div>
                <div class="form-group">
                    <label class="form-label">Deskripsi</label>
                    <input require type="text" class="form-control" name="deskripsi_staff">
                </div>
                <div class="mb-3">
                    <label for="formFile" class="form-label">Gambar</label>
                    <input class="form-control" type="file" id="formFile" name="foto_staff">
                </div>
            </form>
        </div>
