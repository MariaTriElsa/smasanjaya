                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td><?= $no++ ?></td>
                            <td><?= $b->nama_staff  ?></td>
                            <td><?= $b->jabatan_staff ?></td>
                            <td><?= $b->foto_staff ?></td>
                            <td><?= $b->deskripsi ?></td>
                            
                            <td>
                                <a href="<?= site_url("staff/ubah/$b->id_staff") ?>" class="btn btn-warning btn-sm">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <a href="#" data-id="<?= $b->id_staff ?>" class="btn btn-danger btn-sm btn-delete-staff">
