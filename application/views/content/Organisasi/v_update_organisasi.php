        ...
        <div class="card-body">
            <form id="form-update-organisasi" method="post" action="<?= site_url('organisasi/update') ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control"  rows="30" cols="120" name="deskripsi"><?php echo $organisasi->deskripsi; ?></textarea>
                </div>
                <div class="mb-3">
					...
					<div class="container">
						<div class="row">
							<div class="col-sm-12 col-md-12 col-lg-9 mb-3">
								<input class="form-control" value="<?= $organisasi->gambar?>" type="file" id="formFile" name="gambar" required>
								<input value="<?= $organisasi->gambar?>" type="hidden" id="formFile" name="gambar" required>
							</div>
