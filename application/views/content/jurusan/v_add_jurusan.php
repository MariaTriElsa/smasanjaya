        ...
        <div class="card-body">
            <form id="form-tambah-jurusan" method="post" action="<?= site_url('jurusan/insert') ?>" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input required type="text" class="form-control" name="nama_jurusan">
                </div>
                <div class="form-group">
                    <label class="form-label">Deskripsi</label>
                    <textarea required type="" class="form-control" name="deskripsi_jurusan"></textarea>
                </div>
                <div class="form-group">
                    <label class="form-label">Keunggulan</label>
                    <textarea required type="" class="form-control" name="keunggulan_jurusan"></textarea>
                </div>
